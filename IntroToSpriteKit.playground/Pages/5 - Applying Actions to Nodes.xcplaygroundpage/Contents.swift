...
let actionMoveRight = SKAction.moveBy(x: 255, y: 0, duration: 0.5)
let actionReallyLongWaitThenMoveRight = SKAction.sequence([actionTwentySecondWait, actionMoveRight])
circle1.run(actionReallyLongWaitThenMoveRight)
// Exercise 2: Write your code below.
let actionMoveLeft = SKAction.moveBy(x: -255, y: 0, duration: 0.5)
let waitUpLeft = SKAction.sequence([actionTwentySecondWait, actionUpwardsMovement, actionMoveLeft])
circle2.run(waitUpLeft)
